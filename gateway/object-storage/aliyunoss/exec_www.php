...
$this->addjs($this->dir_webroot.'static/aliyun/aliyun-oss-sdk.min.js');
$this->addjs($this->dir_webroot.'static/aliyun/uploadoss.js');
$f = $this->tpl->val('_rs');
if($f && $f['cate_id']){
...
$tplfile = $this->dir_gateway.'object-storage/aliyunoss/btn_www.html';
