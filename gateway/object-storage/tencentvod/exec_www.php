...
$this->addjs($this->dir_webroot.'static/tencentyun/vod-js-sdk-v6.js');
$this->addjs($this->dir_webroot.'static/tencentyun/upload.js');
$f = $this->tpl->val('_rs');
if($f && $f['cate_id']){
...
$tplfile = $this->dir_gateway.'object-storage/tencentvod/btn_www.html';
