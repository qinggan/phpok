<?php
/*****************************************************************************************
	文件： payment/asiabill/notify.php
	备注： Notify通知
	版本： 4.x
	网站： www.phpok.com
...
class asiabill_notify
{
	...
	public function submit()
	{
		...
		//$p_array['trade_no'] = $tradeNo;
		//$p_array['cardNo'] = $app->get('cardNo');
		//$p_array['orderInfo'] = $app->get('orderInfo');
		//$p_array['authTypeStatus'] = $app->get('authTypeStatus');
		//$p_array['riskInfo'] = $app->get('riskInfo');
