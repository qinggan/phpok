				...
				elements : [
					{
						...
						children:[{
							...
							children:[{
								type : 'text',
								id : 'default_ti',
								label : '<strong>'+editor.lang.syntaxhighlight.codeTitleLbl+'</strong>',
								setup : function(data) {
							...
							children:[{
								type : 'text',
								id : 'default_lc',
								label : '<strong>'+editor.lang.syntaxhighlight.lineCount+'</strong>',
								setup : function(data) {
									if(data.firstLine>1) {
							...
							children : [{
								type : 'text',
								id : 'default_hl',
								label : '<strong>'+editor.lang.syntaxhighlight.highlight+'</strong>',
								setup : function(data) {
							...
							children : [
								{
									type : 'html',
									html : '<i style="line-height:28px;">'+editor.lang.syntaxhighlight.highlightLbl+'</i>'
								}
							]
						},{
							type : 'vbox',
							children : [
								{
									type : 'html',
									html : '<strong style="line-height:28px;">其他属性操作</strong>'
								}
							]
						},{
							type:'vbox',
