...
CREATE TABLE IF NOT EXISTS `qinggan_cart` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='购物车' AUTO_INCREMENT=28 ;
...
(24, '3evi8696nl7liqmt4qfspa9je4', 23, 1440912340),
(18, '025q7cksh0e8at3ni1n5bsln70', 0, 1439966435),
(13, 'rhpbet3ej7itatr3biuotdumm2', 24, 1439398701),
(23, '9pmsk83gdonh2os3mlqhis6t30', 23, 1440912110),
...
CREATE TABLE IF NOT EXISTS `qinggan_cart_product` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='购物车里的产品信息' AUTO_INCREMENT=21 ;
...
CREATE TABLE IF NOT EXISTS `qinggan_express` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='快递平台管理' AUTO_INCREMENT=3 ;
...
(1, 1, '宅急送', '北京宅急送快运股份有限公司', 'http://www.zjs.com.cn/', 'zjs', 10, 'a:1:{s:18:"logisticProviderID";s:0:"";}');
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='内容主表' AUTO_INCREMENT=1426 ;
...
(1306, 0, 191, 24, 45, 1, '施华洛世奇（Swarovski） 浅粉蓝色雨滴项链', 1410443859, 0, 1, 0, 189, '', '', '', '', '', 'n', 0, 0, ''),
...
(1253, 0, 168, 24, 45, 1, '新款男人时尚长袖格子衬衫', 1391830871, 0, 1, 0, 130, '', '', '', '', '', '', 1404983732, 0, ''),
...
(1382, 0, 68, 22, 43, 1, '站点采用HTTPS协议的利弊分析、及SEO建议', 1433723870, 0, 1, 0, 107, '', '', '', '', '自检清单 必应 谷歌', '', 1439556917, 0, ''),
(1389, 0, 211, 68, 144, 1, '清水岩，内奉中国百仙之一清水祖师', 1430579244, 0, 1, 0, 9, '', '', '', '', '', '', 0, 0, ''),
(1386, 0, 211, 68, 144, 1, '开元寺，泉州古城的独特标志和象征', 1430559208, 0, 1, 0, 36, '', '', '', '', '', '', 0, 0, ''),
(1396, 0, 207, 22, 43, 1, '测试添加视频', 1435918965, 0, 1, 0, 29, '', '', '', '', '', '', 1439432798, 18, ''),
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='订单中心' AUTO_INCREMENT=37 ;
...
CREATE TABLE IF NOT EXISTS `qinggan_order_address` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='订单地址库' AUTO_INCREMENT=51 ;
...
CREATE TABLE IF NOT EXISTS `qinggan_order_express` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='订单中涉及到的物流分配' AUTO_INCREMENT=2 ;
...
(1, 36, 1, 'sd123456', 1442639077, 0, '宅急送', 'http://www.zjs.com.cn/', '北京宅急送快运股份有限公司', 0);
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='订单日志，用于了解当前的订单处理进度' AUTO_INCREMENT=11 ;
...
(8, 36, 0, 1441868139, 'admin', '管理员创建订单，等待系统确认'),
(9, 36, 0, 1441868139, 'admin', '管理员录入支付信息'),
(10, 36, 1, 1442639077, 'admin', '您的订单已经拣货完毕，待出库交付宅急送，运单号为：sd123456');
...
CREATE TABLE IF NOT EXISTS `qinggan_order_payment` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='订单支付' AUTO_INCREMENT=4 ;

--
-- 转存表中的数据 `qinggan_order_payment`
--

INSERT INTO `qinggan_order_payment` (`id`, `order_id`, `payment_id`, `title`, `price`, `dateline`, `ext`) VALUES
(1, 35, 1, '支付宝快捷支付', '291.0000', 1441855402, ''),
(3, 36, 2, 'Paypal在线支付', '562.0000', 1441868139, '');
...
CREATE TABLE IF NOT EXISTS `qinggan_order_price` (
  ...
  PRIMARY KEY (`id`),
  KEY `order_id` (`order_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='订单金额明细清单' AUTO_INCREMENT=44 ;
...
CREATE TABLE IF NOT EXISTS `qinggan_order_product` (
  ...
  `unit` varchar(50) NOT NULL COMMENT '单位',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='订单的产品信息' AUTO_INCREMENT=47 ;
...
CREATE TABLE IF NOT EXISTS `qinggan_payment` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='支付方案' AUTO_INCREMENT=4 ;
...
(1, 1, 'alipay', '支付宝快捷支付', 'CNY', '', '', '', 1, 30, '', 'a:4:{s:3:"pid";b:0;s:3:"key";b:0;s:5:"email";b:0;s:5:"ptype";s:25:"create_direct_pay_by_user";}'),
...
('forice', '先禾官网扩展', 'Couke.Com', '1.0', 0, 5, '先禾官网扩展功能，如返利等操作', 'a:9:{s:7:"root_id";s:1:"2";s:13:"rebates_param";s:4:"0.15";s:7:"menu_id";i:72;s:18:"rebates_identifier";s:5:"price";s:8:"minprice";s:3:"300";s:8:"group_id";s:1:"2";s:7:"enddate";s:7:"enddate";s:9:"orderdate";s:10:"2015-08-01";s:10:"project_id";s:2:"45";}'),
('share', '分享推广链接', 'phpok.com', '1.0', 1, 30, '实现会员推广获取积分', 'a:3:{s:5:"getid";s:4:"code";s:7:"menu_id";i:74;s:7:"root_id";s:1:"4";}'),
('collection', '采集器', 'phpok.com', '1.0', 1, 255, '实现网站基本信息采集，适用于网站迁移', 'a:2:{s:7:"root_id";s:1:"4";s:10:"sysmenu_id";i:76;}');
...
CREATE TABLE IF NOT EXISTS `qinggan_plugin_duanxincm` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='插件莫名短信验证码' AUTO_INCREMENT=15 ;
...
(14, '4059', '15818533971', 1439398744, 1439399044, 1, 'register');
...
--
-- 表的结构 `qinggan_plugin_share`
--

CREATE TABLE IF NOT EXISTS `qinggan_plugin_share` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `code` varchar(255) NOT NULL COMMENT '分享代码',
  `addtime` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `lasttime` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '最后一次有效时间',
  `hits` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '有效执行次数',
  `user_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '会员ID号',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='推广分享链' AUTO_INCREMENT=4 ;

--
-- 转存表中的数据 `qinggan_plugin_share`
--

INSERT INTO `qinggan_plugin_share` (`id`, `code`, `addtime`, `lasttime`, `hits`, `user_id`) VALUES
(1, 'b84a3066b320c4b7', 1439398582, 1439398700, 1, 23),
(2, '5d1876ccfe20cbb8', 1439398790, 0, 0, 24),
(3, '5d6551fd2ab88ed6', 1439405960, 0, 0, 0);

-- --------------------------------------------------------

--
-- 表的结构 `qinggan_plugin_share_log`
--

CREATE TABLE IF NOT EXISTS `qinggan_plugin_share_log` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `share_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '分享ID',
  `ip` varchar(255) NOT NULL COMMENT 'IP地址库',
  `sessid` varchar(255) NOT NULL COMMENT 'SESSION标识',
  `link` varchar(255) NOT NULL COMMENT '当前网址',
  `flink` varchar(255) NOT NULL COMMENT '来源网址',
  `addtime` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='推广分享链使用日志' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `qinggan_popedom` (
  ...
  PRIMARY KEY (`id`),
  KEY `gid` (`gid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='权限明细' AUTO_INCREMENT=779 ;
...
CREATE TABLE IF NOT EXISTS `qinggan_res` (
  ...
  PRIMARY KEY (`id`),
  KEY `ext` (`ext`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='资源ID' AUTO_INCREMENT=992 ;
...
(991, 1, 'res/201509/05/', '83274f7623d26479.flv', 'flv', 'res/201509/05/83274f7623d26479.flv', 'images/filetype-large/flv.jpg', 1441432690, '罗大佑《随缘》', '', '', '', 0, 0, 1);
...
--
-- 表的结构 `qinggan_site_order_status`
--

CREATE TABLE IF NOT EXISTS `qinggan_site_order_status` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `site_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '站点ID',
  `title` varchar(255) NOT NULL COMMENT '状态名称',
  `identifier` varchar(100) NOT NULL COMMENT '状态标识',
  `taxis` tinyint(1) NOT NULL DEFAULT '0' COMMENT '排序',
  `email_tpl_user` varchar(100) NOT NULL COMMENT '通知用户邮件模板',
  `email_tpl_admin` varchar(100) NOT NULL COMMENT '通知管理员邮件模板',
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0不启用，1启用',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='订单状态管理' AUTO_INCREMENT=7 ;

--
-- 转存表中的数据 `qinggan_site_order_status`
--

INSERT INTO `qinggan_site_order_status` (`id`, `site_id`, `title`, `identifier`, `taxis`, `email_tpl_user`, `email_tpl_admin`, `status`) VALUES
(1, 1, '创建订单', 'create', 1, 'order_admin', 'order_admin', 1),
(2, 1, '等待付款', 'unpaid', 2, '', '', 1),
(3, 1, '付款完成', 'paid', 3, 'register_code', 'order_admin', 1),
(4, 1, '商家发货', 'shipped', 4, 'order_admin', '', 1),
(5, 1, '客户签收', 'received', 5, 'order_admin', 'order_admin', 1),
(6, 1, '订单评论', 'comment', 6, '', '', 0);
...
CREATE TABLE IF NOT EXISTS `qinggan_sysmenu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='PHPOK后台系统菜单' AUTO_INCREMENT=78 ;
...
(72, 2, '返利管理', 0, 'plugin', 40, 'exec', '', 'id=forice&exec=manage', 0, 1, ''),
(74, 4, '分享推广', 1, 'plugin', 255, 'exec', '', 'id=share&exec=manage', 0, 1, ''),
(76, 4, '采集器', 1, 'plugin', 255, 'exec', '', 'id=collection&exec=manage', 0, 1, ''),
...
CREATE TABLE IF NOT EXISTS `qinggan_task` (
  ...
  `month` varchar(5) NOT NULL COMMENT '用',
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='计划任务' AUTO_INCREMENT=3 ;
...
(1, '2015', '09', '10', '14', '12', '29', 0, 0, 'order', 'notice=35', 1, 0),
(2, '2015', '09', '10', '14', '55', '44', 0, 0, 'order', 'notice=36', 1, 0);

-- --------------------------------------------------------

--
-- 表的结构 `qinggan_task_log`
--

CREATE TABLE IF NOT EXISTS `qinggan_task_log` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `task_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '计划任务ID',
  `note` varchar(255) NOT NULL COMMENT '执行内容说明',
  `action` varchar(100) NOT NULL COMMENT '执行动作',
  `param` varchar(100) NOT NULL COMMENT '执行参数',
  `dateline` int(11) NOT NULL COMMENT '执行时间',
  `is_success` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0失败1成功',
  PRIMARY KEY (`id`)
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='临时表单存储器' AUTO_INCREMENT=15 ;
...
(14, 'project-151', 1, 'a:3:{s:2:"id";s:3:"151";s:5:"title";s:12:"下载中心";s:6:"banner";s:0:"";}'),
...
(13, 'project-45', 1, 'a:4:{s:2:"id";s:2:"45";s:5:"title";s:12:"产品展示";s:6:"banner";s:0:"";s:7:"entitle";s:10:"Categories";}');
...
CREATE TABLE IF NOT EXISTS `qinggan_wealth_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='财富获取或消耗日志' AUTO_INCREMENT=53 ;
