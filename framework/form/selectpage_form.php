...
class selectpage_form extends _init_auto
{
	...
	public function phpok_config()
	{
		...
		$this->view($this->dir_phpok.'form/html/selectpage_admin.html','abs-file');
	}
	...
	public function phpok_format($rs,$appid="admin")
	{
		...
		if(!$rs['selectpage_psize']){
			$rs['selectpage_psize'] = 10;
		}
		$this->assign("_rs",$rs);
		$this->assign("_rslist",$rslist);
		
		$file = $appid == 'admin' ? $this->dir_phpok.'form/html/selectpage_admin_tpl.html' : $this->dir_phpok.'form/html/selectpage_www_tpl.html';
